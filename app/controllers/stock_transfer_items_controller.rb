class StockTransferItemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @stock_transfer_item.save
        format.html { redirect_to @stock_transfer_item, notice: "Stock transfer item was successfully created." }
  ...
  def update
    respond_to do |format|
      if @stock_transfer_item.update(stock_transfer_item_params)
        format.html { redirect_to @stock_transfer_item, notice: "Stock transfer item was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to stock_transfer_items_path, status: :see_other, notice: "Stock transfer item was successfully destroyed." }
  ...
  private
    ...
    def stock_transfer_item_params
      params.require(:stock_transfer_item).permit(:nile_product_id, :stock_transfer_id, :transfer_quantity)
    end
end
