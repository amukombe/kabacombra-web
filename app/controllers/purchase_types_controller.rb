class PurchaseTypesController < ApplicationController
  ...
  def index
    @purchase_types = PurchaseType.search(params).page(params[:page]).per(20)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @purchase_type.save
        format.html { redirect_to purchase_types_path, notice: "Purchase type was successfully created." }
  ...
  def update
    respond_to do |format|
      if @purchase_type.update(purchase_type_params)
        format.html { redirect_to purchase_types_path, notice: "Purchase type was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to purchase_types_path, status: :see_other, notice: "Purchase type was successfully destroyed." }
