...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference("Discount.count") do
      post discounts_url, params: { discount: { active: @discount.active, discount_type: @discount.discount_type, discount_value: @discount.discount_value, name: @discount.name } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { active: @discount.active, discount_type: @discount.discount_type, discount_value: @discount.discount_value, name: @discount.name } }
