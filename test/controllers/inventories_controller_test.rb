...
class InventoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory" do
    assert_difference("Inventory.count") do
      post inventories_url, params: { inventory: { order_id: @inventory.order_id, total: @inventory.total } }
    end
  ...
  test "should update inventory" do
    patch inventory_url(@inventory), params: { inventory: { order_id: @inventory.order_id, total: @inventory.total } }
