...
class TerritoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create territory" do
    assert_difference("Territory.count") do
      post territories_url, params: { territory: { address: @territory.address, department_id: @territory.department_id, name: @territory.name, telephone: @territory.telephone } }
    end
  ...
  test "should update territory" do
    patch territory_url(@territory), params: { territory: { address: @territory.address, department_id: @territory.department_id, name: @territory.name, telephone: @territory.telephone } }
