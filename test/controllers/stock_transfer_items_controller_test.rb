...
class StockTransferItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stock_transfer_item" do
    assert_difference("StockTransferItem.count") do
      post stock_transfer_items_url, params: { stock_transfer_item: { nile_product_id: @stock_transfer_item.nile_product_id, stock_transfer_id: @stock_transfer_item.stock_transfer_id, transfer_quantity: @stock_transfer_item.transfer_quantity } }
    end
  ...
  test "should update stock_transfer_item" do
    patch stock_transfer_item_url(@stock_transfer_item), params: { stock_transfer_item: { nile_product_id: @stock_transfer_item.nile_product_id, stock_transfer_id: @stock_transfer_item.stock_transfer_id, transfer_quantity: @stock_transfer_item.transfer_quantity } }
