...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference("Truck.count") do
      post trucks_url, params: { truck: { car_make_id: @truck.car_make_id, chasis: @truck.chasis, model: @truck.model, plate_number: @truck.plate_number, status: @truck.status } }
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { car_make_id: @truck.car_make_id, chasis: @truck.chasis, model: @truck.model, plate_number: @truck.plate_number, status: @truck.status } }
