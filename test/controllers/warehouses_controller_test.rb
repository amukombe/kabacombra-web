...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference("Warehouse.count") do
      post warehouses_url, params: { warehouse: { name: @warehouse.name, territory_id: @warehouse.territory_id, user_id: @warehouse.user_id } }
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { name: @warehouse.name, territory_id: @warehouse.territory_id, user_id: @warehouse.user_id } }
